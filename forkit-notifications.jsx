  ...
  return (
    <div className="min-h-screen flex flex-col bg-surface">
      <header className="flex items-center gap-3 px-5 py-4">
        ...
        <h1 className="font-display text-[32px] leading-[40px] tracking-[-0.01em] font-bold text-primary">Notifications</h1>
      </header>
          ...
          return (
            <section key={group}>
              <div className="flex items-center gap-2 mb-3">
                ...
                <h2 className="font-display text-2xl font-semibold text-primary">{group}</h2>
              </div>
                  ...
                  <div key={n.id} className="bg-surface-container-lowest border border-outline-variant/40 rounded-lg p-3">
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        ...
                        <p className="text-sm font-medium text-on-surface-variant mt-0.5">{n.detail}</p>
                      </div>
                      <span className="text-xs font-medium text-outline shrink-0">{n.time}</span>
                    </div>
                  </div>
                ))}
              </div>
